...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        VKSdk.initialize(withAppId: ConfigurationManager.shared.configApiVK.appId)
        Appodeal.initialize(withApiKey: ConfigurationManager.shared.configApiVK.appodealKey, types: [.banner, .nativeAd], hasConsent: true)
